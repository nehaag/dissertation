...
three key aspects of such systems that we have studied in this thesis:
...
Simple but effective page placement algorithms have enormous durability, with no
...
\textbf{NVM technology in cloud deployments:} Slower but cheaper memory
